package microservices.course.auth.security.user;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import microservices.course.core.model.ApplicationUser;
import microservices.course.core.repository.ApplicationUserRepository;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        /*poderia retornar o userDetails, mas achou melhor criar uma outra classe
        pra ganhar mais flexibilidade */
    }
